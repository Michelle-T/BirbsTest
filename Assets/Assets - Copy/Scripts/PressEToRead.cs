...
public class PressEToRead : MonoBehaviour
{
	...
	public string text1 = "WASD to move\nSpacebar to jump\nT to switch between camera modes\nRMB to take a picture\nP to pause\nN to lose";
	...
	private void OnGUI()
	{
		if(reading)
		{
			GUI.TextArea(new Rect(Screen.height / 2, Screen.width / 2, 500, 500), text1);
